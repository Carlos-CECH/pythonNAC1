...
#filtro do circulo de baixo
image_lower_hsv1 = np.array([0, 90, 100])  
image_upper_hsv1 = np.array([10, 255, 255])

#filtro do circulo de cima
...
def desenha_cruz(img, cX,cY, size, color):
     ...
     cv2.line(img,(cX,cY - size),(cX, cY + size),color,5) # Cópia da máscara para ser desenhada "por cima"
